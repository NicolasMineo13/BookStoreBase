...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        <?php echo e(__('Vous avez oublié votre mot de passe? Pas de problèmes. Entrez votre email et nous vous enverrons un lien pour que vous puissiez changer votre mot de passe')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','class' => 'block mt-1 w-full input_white','type' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'required' => true,'autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\Miste\Desktop\IUT\Maintenance applicative\BookStoreBase\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>